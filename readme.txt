...
Contributors: theeventscalendar, gugaalves
...
A Pure CSS event slider, providing the shortcode [events_slider] to show events.

== Description ==

The [events_slider] accepts the following parameters (attributes):
